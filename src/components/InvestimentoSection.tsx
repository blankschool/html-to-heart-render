  ...
  <section id="investimento" className="py-[72px] px-6 md:py-[100px] md:px-[52px] bg-ink-2" style={{ borderBottom: '1px solid rgba(240,237,230,0.08)' }}>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-end mb-14">
      <div>
        ...
        <h2 className="font-display font-normal leading-[0.96] text-cream" style={{ fontSize: 'clamp(40px, 5vw, 72px)', letterSpacing: '-2px' }}>
          Seu canal mais lucrativo<br /><em className="italic" style={{ color: 'rgba(240,237,230,0.3)' }}>está disponível.</em><br />Basta ativá-lo.
        </h2>
      </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] mt-14 bg-ink-2" style={{ border: '1px solid rgba(240,237,230,0.08)', borderTop: '2px solid hsl(42 33% 92%)' }}>
      <div className="p-[48px_40px] flex flex-col" style={{ borderRight: '1px solid rgba(240,237,230,0.08)' }}>
        <div className="font-mono-brand text-[9px] tracking-[3px] uppercase mb-5" style={{ color: 'rgba(240,237,230,0.55)' }}>Programa Influentes</div>
        <div className="font-display text-[50px] font-normal text-cream leading-none mb-1.5" style={{ letterSpacing: '-2px' }}>R$ 100.000</div>
        <div className="font-mono-brand text-[11px] mb-9" style={{ color: 'rgba(240,237,230,0.55)' }}>Parcelamento disponível | Consulte condições</div>
        ...
        <div className="font-mono-brand text-[10px] text-center leading-[1.6]" style={{ color: 'rgba(240,237,230,0.35)' }}>Por candidatura · R$10M+ de faturamento · 30 vagas por turma</div>
      </div>
      <div className="p-[48px_24px] md:p-[48px_44px] flex flex-col justify-between gap-7">
        <div className="grid grid-cols-1 md:grid-cols-2">
          {items.map((item, i) => (
            <div key={i} className="flex gap-2.5 text-[12.5px] font-light py-2 items-baseline" style={{ color: 'rgba(240,237,230,0.85)', borderBottom: '1px solid rgba(240,237,230,0.04)' }}>
              <span className="font-mono-brand text-[10px] flex-shrink-0" style={{ color: 'rgba(240,237,230,0.55)' }}>✓</span>
              {item}
            </div>
          ))}
        </div>
        <div className="text-[12px] font-light leading-[1.7] pt-[18px]" style={{ color: 'rgba(240,237,230,0.55)', borderTop: '1px solid rgba(240,237,230,0.08)' }}>
