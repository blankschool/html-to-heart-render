  ...
  <section id="investimento" className="relative overflow-hidden" style={{ background: 'hsl(42 33% 92%)', borderBottom: '1px solid rgba(10,10,8,0.08)' }}>
    ...
    <div className="relative z-10 px-6 md:px-[52px] pt-[72px] md:pt-[100px] pb-14">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-end">
        <div>
          <div className="font-mono-brand text-[12px] font-medium tracking-[4px] uppercase flex items-center gap-3.5 mb-6" style={{ color: 'rgba(10,10,8,0.45)' }}>
        ...
        <p className="text-[17px] font-light leading-[1.85] pt-0 md:pt-[52px]" style={{ color: 'rgba(10,10,8,0.65)' }}>
    ...
    <div className="relative z-10 mx-6 md:mx-[52px] mb-[72px] md:mb-[100px]">
      ...
      >
        <div className="p-[48px_40px] flex flex-col" style={{ borderRight: '1px solid rgba(240,237,230,0.06)' }}>
          <div className="font-mono-brand text-[11px] tracking-[3px] uppercase mb-5" style={{ color: 'rgba(240,237,230,0.55)' }}>Programa Influentes</div>
          ...
          <p className="text-[15px] font-light leading-[1.75] mb-9 flex-1" style={{ color: 'rgba(240,237,230,0.68)' }}>
            Envie sua aplicação e nosso time de especialistas entrará em contato para apresentar o programa e o investimento.
          </p>
          <a href="#" className="block w-full py-4 text-center font-mono-brand text-[13px] font-medium tracking-[2px] uppercase bg-cream text-ink no-underline transition-opacity hover:opacity-[0.88] mb-3">
            Enviar Aplicação
          </a>
          <div className="font-mono-brand text-[12px] text-center leading-[1.6]" style={{ color: 'rgba(240,237,230,0.45)' }}>
        ...
        <div className="p-[48px_24px] md:p-[48px_44px] flex flex-col justify-between gap-7">
          <div className="grid grid-cols-1 md:grid-cols-2">
            {items.map((item, i) => (
              <div key={i} className="flex gap-2.5 text-[15px] font-light py-2 items-baseline" style={{ color: 'rgba(240,237,230,0.88)', borderBottom: '1px solid rgba(240,237,230,0.05)' }}>
                <span className="font-mono-brand text-[12px] flex-shrink-0" style={{ color: 'rgba(212,200,154,0.7)' }}>✓</span>
                {item}
              </div>
            ))}
          </div>
          <div className="text-[14px] font-light leading-[1.7] pt-[18px]" style={{ color: 'rgba(240,237,230,0.5)', borderTop: '1px solid rgba(240,237,230,0.06)' }}>
