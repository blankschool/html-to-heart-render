...
const IconLeads = ({ color }: { color: string }) => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke={color} strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round">
    <polyline points="3,16 7,10 11,13 18,5" />
    <polyline points="13,5 18,5 18,10" />
    <circle cx="3" cy="16" r="1.5" fill={color} stroke="none" />
  </svg>
);
...
const IconTalent = ({ color }: { color: string }) => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke={color} strokeWidth="1.3" strokeLinecap="round">
    ...
    <path d="M2 19 C2 14.5 14 14.5 14 19" />
    <path d="M17 3 L17.65 5.2 L20 5.2 L18.1 6.6 L18.75 8.8 L17 7.4 L15.25 8.8 L15.9 6.6 L14 5.2 L16.35 5.2 Z" fill={color} stroke="none" />
  </svg>
);
...
const IconDeal = ({ color }: { color: string }) => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke={color} strokeWidth="1.3" strokeLinecap="round">
    ...
    <line x1="11" y1="14" x2="14" y2="11" />
  </svg>
);

const IconAsset = ({ color }: { color: string }) => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke={color} strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round">
    <path d="M11 2 L20 8 L20 14 L11 20 L2 14 L2 8 Z" />
  ...
  return (
    <section className="py-[72px] px-6 md:py-[100px] md:px-[52px] relative bg-ink" style={{ borderBottom: '1px solid rgba(240,237,230,0.08)' }}>
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-[19px] font-light leading-[1.85] mt-6 mx-auto" style={{ color: 'rgba(240,237,230,0.93)', maxWidth: '520px' }}>
        ...
        {frentes.map((f, i) => {
          ...
          return (
            ...
            >
              ...
              <div className="text-[17px] font-medium text-cream mb-2.5">{f.title}</div>
