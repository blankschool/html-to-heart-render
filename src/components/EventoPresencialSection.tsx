...
const EventoPresencialSection = () => (
  <section className="bg-ink-2 overflow-hidden" style={{ borderBottom: '1px solid rgba(240,237,230,0.08)' }}>
    <div
      className="px-6 md:px-[52px] py-5 font-mono-brand text-[12px] font-medium tracking-[4px] uppercase flex items-center gap-3.5"
    ...
    <div className="grid grid-cols-1 md:grid-cols-2" style={{ minHeight: '680px' }}>
      <div className="flex flex-col" style={{ borderRight: '1px solid rgba(240,237,230,0.08)' }}>
        <div className="px-6 md:px-[52px] pt-10 pb-8">
          <h2 className="font-display font-normal leading-[0.94] text-cream" style={{ fontSize: 'clamp(44px, 5.5vw, 80px)', letterSpacing: '-2.5px' }}>
            Evento presencial
          </h2>
        </div>
        ...
        <div className="grid grid-cols-2" style={{ borderTop: '1px solid rgba(240,237,230,0.08)' }}>
          <div className="p-[24px_32px]" style={{ borderRight: '1px solid rgba(240,237,230,0.08)' }}>
            ...
            <div className="font-mono-brand text-[12px] tracking-[0.5px]" style={{ color: 'rgba(240,237,230,0.68)' }}>por ano (a cada 4 meses)</div>
          </div>
          <div className="p-[24px_32px]">
            ...
            <div className="font-mono-brand text-[12px] tracking-[0.5px]" style={{ color: 'rgba(240,237,230,0.68)' }}>por membro / ano</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2" style={{ gap: '1px', background: 'rgba(240,237,230,0.07)', alignContent: 'stretch' }}>
        {cards.map((c, i) => (
          ...
          >
            <div className="font-serif-body text-[19px] font-normal leading-[1.3] mb-4" style={{ color: 'rgba(240,237,230,0.9)' }}>{c.title}</div>
            <p className="text-[15px] font-light leading-[1.75]" style={{ color: 'rgba(240,237,230,0.85)' }}>{c.body}</p>
          </div>
        ))}
      </div>
    </div>
