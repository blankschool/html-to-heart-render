      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-end mb-[52px]">
        ...
        <div className="pt-0 md:pt-[52px]">
          ...
          <div className="mt-6 p-[20px_24px]" style={{ border: '1px solid rgba(240,237,230,0.08)', borderTop: '2px solid rgba(240,237,230,0.35)' }}>
            <div className="font-mono-brand text-[9px] tracking-[3px] uppercase mb-2" style={{ color: 'rgba(240,237,230,0.72)' }}>Resultado do Assessment</div>
            <p className="text-[13px] font-light leading-[1.7]" style={{ color: 'rgba(240,237,230,0.92)' }}>
      ...
      <div ref={ref} className="grid grid-cols-1 md:grid-cols-3" style={{ gap: '1px', background: 'rgba(240,237,230,0.08)', border: '1px solid rgba(240,237,230,0.08)' }}>
        {nivels.map((n, i) => (
          <div key={i} className="bg-ink p-[32px_28px] relative transition-colors hover:bg-ink-2">
            ...
            <div className="font-mono-brand text-[9px] tracking-[2.5px] uppercase mb-3" style={{ color: 'rgba(240,237,230,0.68)' }}>{n.tag}</div>
            <div className="text-[16px] font-medium mb-2.5" style={{ color: 'rgba(240,237,230,0.9)' }}>{n.title}</div>
            <p className="text-[12.5px] font-light leading-[1.7]" style={{ color: 'rgba(240,237,230,0.90)' }}>{n.body}</p>
          </div>
        ))}
      </div>
    </section>
