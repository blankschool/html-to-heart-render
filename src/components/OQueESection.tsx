        ...
        <div className="flex flex-col mb-8">
          {notItems.map((text, i) => (
            <div key={i} className="flex gap-4 items-baseline py-3.5" style={{ borderBottom: '1px solid rgba(240,237,230,0.04)' }}>
              <span className="font-mono-brand text-[14px] flex-shrink-0" style={{ color: 'rgba(240,237,230,0.60)' }}>✕</span>
              <span className="text-[15px] font-light line-through" style={{ color: 'rgba(240,237,230,0.60)', textDecorationColor: 'rgba(240,237,230,0.12)' }}>{text}</span>
            </div>
          ))}
        </div>
      </div>
      <div>
        <div className="font-mono-brand text-[11px] tracking-[3px] uppercase mb-5" style={{ color: 'rgba(240,237,230,0.68)' }}>O que é</div>
        <div className="font-serif-body text-[20px] font-normal leading-[1.65] mb-8" style={{ color: 'rgba(240,237,230,0.88)' }}>
